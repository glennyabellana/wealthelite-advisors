...
?>
	...
	<main id="primary" class="site-main">
		<div class="hero-container container mx-auto relative">
			...
			<div class="container mx-auto relative h-full overflow-hidden">
				...
				<div class="hero hero-content relative z-10 min-h-[20rem] h-[calc(100vh-162px)] flex flex-col items-start justify-end pb-[10rem] pl-[6rem]">
				<!-- <div class="hero hero-content relative z-10 pt-[10rem] pb-[6rem] pl-[6rem] h-full w-full min-h-[20rem] h-[calc(100vh-162px)] flex flex-col items-start justify-start"> -->
					<h2 class="text-4xl sm:text-[3.75rem] leading-[1.3] font-medium text-white mb-8">What you plan today, <br>you shall harvest in the future.</h2>
