...
?>
	...
	// CLIENT TYPES (repeater under group_6883d19575c3d)
	$client_types_title = get_field( 'client_types_title' );
	$client_types_list  = get_field( 'member_types_list' );

	// INDUSTRIES (clone of group_6883d19575c3d, under 'industries_list')
	$industries_list = get_field( 'industries_list' ); // clone group, so similar structure
