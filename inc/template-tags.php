...
if ( ! function_exists( 'wealthelite_advisors_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function wealthelite_advisors_posted_on() {
...
if ( ! function_exists( 'wealthelite_advisors_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'wealthelite_advisors_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function wealthelite_advisors_entry_footer() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'wealthelite-advisors' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'wealthelite_advisors_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function wealthelite_advisors_post_thumbnail() {
				...
				<?php
					the_post_thumbnail(
						...
						array(
                            ...
                            'class' => 'rounded-primary mx-auto mt-12',
						)
					);
				?>
			</a>
