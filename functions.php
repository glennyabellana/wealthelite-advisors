...
function wealthelite_advisors_scripts() {
	$version = defined( '_S_VERSION' ) ? _S_VERSION : time();
	...
	// Fast, non-blocking socket check (only if sockets allowed).
	...
	// Enqueue all CSS generated by this entry.
